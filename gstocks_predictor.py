# -*- coding: utf-8 -*-
"""Gstocks predictor.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1o1G7lJg9vz4DtLr4BeZUBvBlrceSfvxK
"""

#Description: This program uses artificial recurrent neural network called Long Short Term Memory 
#(LSTM) to predict the closing stock price of a corporation (Google Inc.) using dataset obtained from kaggle.com
...
#Get the quote
google_quote = pd.read_csv('Google_Stocks.csv')
...
#Get the quote
google_quote2 = pd.read_csv('Google_Stocks.csv')